...
class Db
{
     ...
     */
    public static function write(string $sql, float $spentTime, string $traceId = '', string $spanId = '')
    {
        go (function (string $sql, float $spentTime, string $traceId, string $spanId) {
